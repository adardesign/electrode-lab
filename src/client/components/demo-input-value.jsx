...
DemoInputValue.propTypes = {
  inputValue: PropTypes.number.isRequired
};

const mapStateToProps = state => {
  return {
    inputValue: state.inputVal.value
  };
};

export default connect(mapStateToProps, dispatch => ({ dispatch }))(DemoInputValue);
